\section{Procedure}
	We propose and implement the following procedure to mitigate the aforementioned shortcomings. The various subsystems of the simulation are described in \Cref{sec:impl:scanning,sec:impl:computing,sec:impl:tasks}.
