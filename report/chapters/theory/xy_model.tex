\section{XY Model}\label{sec:theo:xy_model}
	...
	\subsection{Observables}
		...
		\paragraph{Helicity Modulus per Spin}
			According to~\cite{teitel_helicity} one can also derive the \emph{spin wave stiffness} or \emph{helicity modulus} $\Upsilon$ which \textquote{is a measure of the phase correlations of the system} (\cite{teitel_helicity}). It can be shown that the \emph{helicity modulus} is given by
