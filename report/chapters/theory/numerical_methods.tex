\section{Numerical Methods}\label{sec:theo:numerical_methods}
	...
	\subsection{Metropolis Algorithm}\label{sec:theo:metropolis}
		...
		\end{equation}
		which follows from \emph{detailed balance}. This procedure generates a Markov chain of dependent configurations that converges to a static distribution, and where any configuration is reachable (condition of \emph{ergodicity}). The overall procedure for the lattice is as follows:
		\begin{enumerate}
