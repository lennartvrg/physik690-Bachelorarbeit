...
\newcommand{\Observable}[3]{\begin{figure}[htbp]
		...
		\caption[Temperature dependence of the #3 per spin (#1)]{Temperature dependence of the #3 per spin using the #1 algorithm for lattice sizes $L \in \{4, 32, 128, 352\}$}
		\label{fig:obs:#1:#2}
\end{figure}}
...
\newcommand{\Autocorrelation}[3]{\begin{figure}[htbp]
		...
		\caption[Autocorrelation function $\Gamma(\Delta t)$ of the #3 per spin (#1)]{Autocorrelation function $\Gamma(\Delta t)$ of the #3 per spin using the #1 algorithm}
...
\newcommand{\IntegratedAutocorrelation}[3]{\begin{figure}[htbp]
		...
		\caption[Integrated autocorrelation time $\tau$ of the #3 per spin (#1)]{Integrated autocorrelation time $\tau$ of the #3 per spin using the #1 algorithm}
