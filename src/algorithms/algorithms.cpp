...
std::tuple<std::vector<double_t>, std::vector<double_t>> algorithms::simulate(Lattice & lattice, const std::size_t sweeps, openrand::Philox & rng, const function & sweep) noexcept {
